...
const Home = (props) => {
  ...
  useEffect(() => {
    gsap.timeline({
      ...
      .from(".Set1", { opacity: 0, duration: 4 }, "+=2")
      .to(".Set1", { opacity: 1, stagger: 0.1 }, "+=2")
      .from(".Set2", { opacity: 0, delay: 4, duration: 4, ease: Sine.easeOut, }, "+=2")
      .to(".Set2", { opacity: 1, stagger: 0.1 }, "+=2")
      .from(".Set3", { opacity: 0, delay: 4, duration: 4, ease: Sine.easeOut, }, "+=2")
      .to(".Set3", { opacity: 1, stagger: 0.1 }, "+=2")
      .from(".Set4", { opacity: 0, delay: 4, duration: 4, ease: Sine.easeOut, }, "+=2")
      .to(".Set4", { opacity: 1, stagger: 0.1 }, "+=2")
      .from(".Set5", { opacity: 0, delay: 0, duration: 4, ease: Sine.easeOut, }, "+=2")
      .to(".Set5", { opacity: 1, stagger: 0.1 }, "+=2");
  }, [])
  ...
  useEffect(() => {
    gsap.timeline({
      ...
      .from(".resume", { opacity: 0, duration: 5, delay: 1 })
      .to(".resume", { opacity: 1, x: 0, y: -50, stagger: 0.1, ease: Sine.easeInOut })
      .from(".social", { opacity: 0, duration: 5, delay: 5, stagger: 1 })
      .to(".social", { opacity: 1, x: 0, y: -50, ease: Sine.easeInOut })
      .from(".return", { opacity: 0, delay: 1, duration: 1, xPercent: -100 }, "+=2")
      .to(".return", { opacity: 1, xPercent: 0, stagger: 0.3, ease: Sine.easeInOut, }, "+=2")
  }, [])
  ...
  return (
    <div className='home relative flex flex-col justify-center items-center bg-slate dark:bg-black' id="top">
      ...
      {/* Fold 1: Home */}
      <div className='text1 relative w-full mb-8 bg-slate dark:bg-black home-content h-screen py-6 px-4 flex flex-col justify-center items-center'>
      ...
      <div className='skills relative w-full mt-16 mb-8 bg-slate dark:bg-black py-6 px-4 h-fit flex flex-col justify-between items-center'>
        ...
        <ul className='list1 ml-6 sm:ml-0'>
          <li className='text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'><span className='text-accent-dark'>var</span> profile = <span className='text-accent-dark'>{"{"}</span></li><br />
          <li className='ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>"<span className='text-darkgray dark:text-lightgray'>Education</span>": <span className='text-darkgray dark:text-lightgray'>{"["}</span>
            <ul className='Set1 ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>
          ...
          <li className='ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>"<span className='text-darkgray dark:text-lightgray'>Tools</span>": <span className='text-darkgray dark:text-lightgray'>{"["}</span>
            <ul className='Set2 ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>
          ...
          <li className='ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>"<span className='text-darkgray dark:text-lightgray'>Interests</span>": <span className='text-darkgray dark:text-lightgray'>{"["}</span>
            <ul className='Set3 ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>
          ...
          <li className='ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>"<span className='text-darkgray dark:text-lightgray'>Job Experience</span>": <span className='text-darkgray dark:text-lightgray'>{"["}</span>
            <ul className='Set4 ml-4 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal height-code'>
              <li><span className='text-accent-dark'>{"{"}</span> "Company": "Spenda",
                ...
                <span className='text-accent-dark'>{"}"}</span>,</li><br />
      ...
      {/* Fold 3: Contact */}
      <div className='contact relative w-full mt-16 mb-8 bg-slate dark:bg-black py-6 px-4 h-full flex flex-col justify-between items-center'>
        ...
        <div className='h-screen w-full px-4 flex flex-col justify-center'>
          <p className='resume text-black dark:text-white text-base sm:text-2xl tracking-wide font-normal'>Let's work together <a href="https://drive.google.com/file/d/1eEehKmYe2TJ9QVhKgyFSBIzJlGFVa12p/view?usp=sharing" rel="noopener noreferrer" className='text-accent-dark hover:text-darkgray hover:dark:text-lightgray text-base sm:text-2xl tracking-wide font-normal'>Resume()</a></p>
          <div className='h-fit w-full flex flex-col justify-center'>
            <ul className='flex flex-col sm:flex-row py-8'>
              <li className='social nav-links sm:mr-5 text-black dark:text-white hover:text-darkgray hover:dark:text-lightgray text-base sm:text-xl tracking-wide font-normal height-code'><a href="https://www.linkedin.com/in/uditmalhotraa/" rel="noopener noreferrer">Linkedin()</a></li>
              <li className='social nav-links sm:mx-5 text-black dark:text-white hover:text-darkgray hover:dark:text-lightgray text-base sm:text-xl tracking-wide font-normal height-code'><a href="https://medium.com/@uditmalhotraa" rel="noopener noreferrer">Medium()</a></li>
              <li className='social nav-links sm:mx-5 text-black dark:text-white hover:text-darkgray hover:dark:text-lightgray text-base sm:text-xl tracking-wide font-normal height-code'><a href="https://instagram.com/uditmalhotraa" rel="noopener noreferrer">Instagram()</a></li>
              <li className='social nav-links sm:ml-5 text-black dark:text-white hover:text-darkgray hover:dark:text-lightgray text-base sm:text-xl tracking-wide font-normal height-code'><a href="https://open.spotify.com/user/8m59lr39cu8zunxmrd9c2uavb?si=4bfc6150bf6b4145" rel="noopener noreferrer">Spotify()</a></li>
            </ul>
          </div>
          <a href="#top" className='return absolute bottom-[2.5rem] left-0 ml-8 text-black dark:text-white text-base sm:text-xl tracking-wide font-normal hover:text-darkgray hover:dark:text-lightgray'>return(<span className='text-accent-dark'>toTop</span>);</a>
        </div>
      </div>
